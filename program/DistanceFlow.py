...
from program.ReadData import read_freq_per_value_data, read_domain_per_attr_data, DATA_TYPE_PER_INDEX, \
    ATTRIBUTE_PER_INDEX, DATA_TYPE_PER_INDEX_EXPERIENCE, DATA_TYPE_PER_INDEX_EDUCATION, EXPERIENCE_ATTRIBUTE_PER_INDEX, \
    EDUCATION_ATTRIBUTE_PER_INDEX, HAMMING_DEFAULT
