...
from ReadData import read_local_json_employees, read_attr_types_data, read_nested_attr_types_data, \
    read_freq_per_value_data, MIN_FREQ, NUMERIC_DEFAULT
...
def create_default_empty_list_for_nested_attr(nested_attr: dict, representation_option_set: DistMethod, attr_name: str,
                                              freq_val: dict) -> list:
...
def create_single_obj_list_for_nested_attr(nested_attr: dict, representation_option_set: DistMethod, attr_name: str,
                                           freq_val: dict, nested_obj: dict) -> list:
    freq_values_per_object = []
...
def loop_candidates_convert_to_freq_vec(representation_option: DistMethod, representation_option_for_set: DistMethod,
    ...
    for row in range(0, len(df)):
        ...
        # logger(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
        rep.append(instance_freq_vec)

    np.save("../clustering/allFreqRep.npy", rep)


if __name__ == '__main__':
    loop_candidates_convert_to_freq_vec(representation_option=DistMethod.fix_length_freq,
